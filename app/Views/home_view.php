    ...
    <div class="container section-title" data-aos="fade-up">
        <h2>Mohd Isral  </h2>
        <p>Saya Mahasiswa Unusia sedang menempuh Pendidikan S1 dengan jurusan Sistem Informasi saat ini saya sedang mengikuti PMM di kantor Pengurus Besar Nahdlatul Ulama Indonesia .</p>
    ...
    <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="col-lg-8 content">
            ...
            <div class="col-lg-6">
                <ul>
                <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span>18 Agustus 2003</span></li>
                <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong> <span>www.example.com</span></li>
                <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span>085249909011</span></li>
            ...
            <div class="col-lg-6">
                ...
                <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span>mohdisral22@gmail.com</span></li>
